...
// functionality in realistic environments. The tests are designed to work with KV Enterprise
// clusters and require specific environment configuration.
//
// Environment Variables:
//   - E2E_SCENARIO_TESTS: Set to "true" to enable scenario tests
//   - KV_ENDPOINTS_CONFIG_PATH: Path to endpoints configuration file
...
//
// Note: Maintenance notifications are currently supported only in standalone KV clients.
